            ...
            <div className="map-content">
                <AnimatePresence mode="wait">
                    {step === 'credentials' ? (
                        ...
                        >
                            <div style={s.header}>
                                <h2 style={s.title}><span style={{ color: '#f59e0b', fontWeight: 900 }}>Sign In</span></h2>
                            ...
                            <form style={s.form} onSubmit={handleLogin}>
                                ...
                                <div style={{ textAlign: 'right', marginTop: '-0.75rem' }}>
                                    <Link to="/forgot-password" style={{ color: '#f59e0b', fontSize: '0.8rem', fontWeight: 600, opacity: 0.85 }}>Forgot Password?</Link>
                                </div>

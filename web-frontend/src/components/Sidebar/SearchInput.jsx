...
const SearchInput = ({ 
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="gm-search-box space-y-6 mt-4">
        {/* Source Input */}
      ...
      <button 
        className="w-full py-4 mt-4 bg-[var(--text-1)] text-[var(--bg)] font-black rounded-2xl text-[12px] uppercase tracking-[0.2em] hover:bg-[var(--accent)] hover:text-white transition-all flex items-center justify-center gap-2 shadow-2xl hover:shadow-[var(--accent-glow)] active:scale-95"
        onClick={onSearch}
